...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Data Pasien Stunting</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                                ...
                                                <tbody>
                                                    <?php foreach ($hasil as $key => $value) : ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo number_format($value['leaving'], 3); ?></td>
                                                            <td><?php echo number_format($value['entering'], 3); ?></td>
                                                            <td><?php echo number_format($value['net_flow'], 3); ?></td>
                                                        </tr>
                                                    <?php endforeach ?>
                                                </tbody>
                                            </table>
                ...
                <div class="col-lg-12">
                    <div class="panel-group">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" href="#collapse2">Tabel Keputusan</a>
                                </h4>
                            </div>
                            <div id="collapse2" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <h3>Tabel Stunting</h3>
                                    <div class="panel panel-info">
                                        <!-- /.panel-heading -->
                                            ...
                                            <table id="dataTables-ranking" class="table table-bordered ctr">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($ranking_hasil as $key => $value) :
                                                        $status = ""; // Inisialisasi variabel status di sini
                                                        if ($value['nilai'] < 0) {
                                                            $status = "Stunting";
                                                        } else {
                                                            $status = "Bukan Stunting";
                                                        }
                                                    ?>
                                                        <tr>
                                                            <td><?= $no++ ?></td>
                                                            <td><?php echo $value['nama'] ?></td>
                                                            <td><?php echo number_format($value['nilai'] ,3) ?></td>
                                                            <td><?= $status ?></td>
                                                        </tr>
                                                    <?php endforeach ?>
                                                </tbody>
